...
## User-visible and evidence-schema impact

## Verification

- [ ] Tests were added or the change is documentation-only.
- [ ] `cargo fmt`, clippy, workspace tests, deny, and audit pass.
- [ ] Documentation/repository/deployment checks pass.
